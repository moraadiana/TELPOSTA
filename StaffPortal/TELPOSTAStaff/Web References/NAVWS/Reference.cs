...
namespace TELPOSTAStaff.NAVWS {
    ...
    public partial class Staffportall : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("return_value")]
        public string LoginForUnchnagedPassword(string username, string password) {
        ...
        /// <remarks/>
        public void LoginForUnchnagedPasswordAsync(string username, string password) {
            this.LoginForUnchnagedPasswordAsync(username, password, null);
        }
        
        /// <remarks/>
        public void LoginForUnchnagedPasswordAsync(string username, string password, object userState) {
            ...
            this.InvokeAsync("LoginForUnchnagedPassword", new object[] {
                        username,
                        password}, this.LoginForUnchnagedPasswordOperationCompleted, userState);
        }
