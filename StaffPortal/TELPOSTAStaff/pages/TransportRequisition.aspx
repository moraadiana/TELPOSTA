                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Company Pays Accommodation</label>
                                                 ...
                                                 <asp:DropDownList ID="ddlCompanyAccommodation" runat="server" CssClass="form-control">
                                       ...
                                       <table class="table table-hover">
                                           ...
                                           <tbody>
                                               <tr>
                                                   ...
                                                   <td>
                                                       <asp:TextBox ID="txtAmount" type="number" runat="server" CssClass="form-control" placeholder="0.00" required="true" ></asp:TextBox>
                                                   </td>
                                                   <td>
                                ...
                                <i class="fa fa-remove"></i> Remove
                                   ...
                                   <table class="table table-hover">
                                       <thead>
                                           <tr>
                                               <td colspan="2">
                                                   <asp:LinkButton ID="LinkButton4" CssClass="btn btn-sm btn-warning btn-flat pull-left" runat="server" OnClick="lbtnBack_Click">
                                <i class="fa fa-backward"></i> Back
                                                   </asp:LinkButton>
                                                   <asp:LinkButton ID="LinkButton5" CssClass="btn btn-success btn-flat btn-sm pull-right" runat="server" OnClick="lbtnToLines_Click">
                                <i class="fa fa-check-circle"></i> Next
                                                   </asp:LinkButton>
                                               </td>
                                           </tr>
                                       </thead>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%-- OnSelectedIndexChanged="ddlAccomodation_SelectedIndexChanged"--%>
                                                        <asp:DropDownList ID="ddlAccommodation" runat="server" CssClass="form-control">
                                                            <asp:ListItem>-- Select -- </asp:ListItem>
                                                            <asp:ListItem Value="1">Yes</asp:ListItem>
                                                            <asp:ListItem Value="2">No</asp:ListItem>
